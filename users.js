...
let updateUsers = "UPDATE kitchen_users SET chat_id=($1) WHERE slack_id=($2);";
...
module.exports = {
    ...
    updateUsersWithChatId : function(chatId, userId, callback){
        console.log("updateUsersWithChatId chat id: ", chatId);
        console.log(updateUsers);
        db.query(updateUsers, [chatId,userId], callback);
    }
}